    ...
    fun generateFormattedEntries(): List<String> {
        ...
        for (i in 0 until entryCount) {
            ...
            val feedback = when (genre) {
                "Puzzle Games" -> "A true brain-teaser!"
                "Adventure Games" -> "Explore new worlds!"
                "Sport Games" -> "Get in the game!"
                "Strategy Games" -> "Think before you act!"
                "Fighting Games" -> "High-octane action!"
                "Racing Games" -> "Speed thrills!"
